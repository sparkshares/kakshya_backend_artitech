...
from .models import ClassRecord, ClassRecordSummary
import json
from .serializers.class_summary_serializer import ClassRecordSummarySerializer
...
def create_class_record_task(self, record_id, file_path):
    ...
    try:
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": "Please give the summary of this video in json format, 'summary' in json format is mandatory and summary should be 500 words"},
